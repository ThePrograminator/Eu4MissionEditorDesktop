...
const Mission = (props) => {
	...
	const [ provincesToHighLight, setProvincesToHighLight ] = useState(props.selectedElement.data.provincesToHighLight);
	...
	useEffect(
		...
		[ nodeName, icon, generic, position, completedBy, provincesToHighLight, trigger, effect, selectedSeries ]
	);
	...
	return (
		<Form>
			...
			<Accordion defaultActiveKey="0">
				<Card>
					...
					<Accordion.Collapse eventKey="0">
						<Card.Body>
							{selectedSeries != null ? (
								<SeriesReadOnly selectedSeries={props.series.find((x) => x.id === selectedSeries)} />
							) : (
								'No Selected Series'
							)}
						</Card.Body>
			...
			<Form.Group controlId="formCompletedBy">
				...
				/>
				<Form.Text className="text-muted">Automatically completes mission in history.</Form.Text>
			</Form.Group>
